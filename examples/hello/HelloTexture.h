...
#define HELLO_BMP_LEN 578

struct HelloTexture : public drakon::component::TextureComponent {
private:
  unsigned int icon_bmp_len = HELLO_BMP_LEN;
  unsigned char icon_bmp[HELLO_BMP_LEN] = {
